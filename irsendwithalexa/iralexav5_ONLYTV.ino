/*
   ...
   explore | learn | share
*/
//functional version, using nec to tv and raw 349 to ac
...
//#endif  // ESP8266
 ...
 // pinMode(R1, OUTPUT);
  ...
  if (wifiConnected)
  {
    ...
    espalexa.addDevice(Device_2_Name, pauseon); //simplest definition, default state off
...
void pauseon(uint8_t on)
{
  ...
  {
    delay(100);
    irsend.sendNEC(0xE0E09D62);
    Serial.println("pausando tv");
